                ...
                <div className="container">
                    <div className="pf-section-header">
                        <span className="pf-section-tag">
                            <FaGraduationCap size={11} /> {t("nav.education")}
                        </span>
                        <h1 className="pf-section-title">{t("education.title")}</h1>
                    </div>
                                        ...
                                        <div key={edu.id} className="pf-timeline-item">
                                            ...
                                            <div className="pf-card" style={{ padding: "1.75rem", marginLeft: "1.25rem" }}>
                                                ...
                                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "0.5rem", marginBottom: "0.75rem" }}>
                                                    ...
                                                    <span className="pf-badge" style={{ background: "rgba(99,102,241,0.08)", color: "#6366f1" }}>
